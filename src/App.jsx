...
export default function App() {
  ...
  const portfolioItems = [
    ...
    { cat: 'wordpress', img: '/src/images/djifashion-collection.jpeg', title: 'DJI Fashion', desc: 'Boutique mode élégante avec catalogue produits, gestion panier et paiement sécurisé • 2026', tags: ['WordPress', 'WooCommerce', 'E-commerce'], site: 'https://djifashion.com/' },
