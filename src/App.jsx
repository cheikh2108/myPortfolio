...
export default function App() {
  ...
  const portfolioItems = [
    { cat: 'product', img: '/src/images/study-matiere.jpeg', title: 'MyStudyPlanner', desc: 'Gestion de tâches académiques • 2026', tags: ['React', 'Vite', 'Tailwind'], github: 'https://github.com/cheikh2108/MyStudyPlanner', site: 'https://mystudyplanner.appwrite.network/' },
    { cat: 'product', img: '/src/images/todolist.jpeg', title: 'TodoList React', desc: 'Application de gestion de tâches simple, rapide et responsive • 2026', tags: ['First Project', 'React', 'Appwrite'], github: 'https://github.com/cheikh2108/todolist-react', site: 'https://todolist-react.appwrite.network' },
    { cat: 'product', img: '/src/images/tacko-menu.jpeg', title: 'Tacko Délices', desc: 'Application web de restaurant avec gestion en temps réel • 2026', tags: ['React', 'Supabase'], github: 'https://github.com/cheikh2108/Tacko-delices', site: 'https://www.tackodelices.foo' },
    { cat: 'wordpress', img: '/src/images/difashion-collection.jpeg', title: 'DJI Fashion', desc: 'Boutique mode élégante avec catalogue produits, gestion panier et paiement sécurisé • 2026', tags: ['WordPress', 'WooCommerce', 'E-commerce'], site: 'https://djifashion.com/' },
    { cat: 'devops', img: '/src/images/cloud-fichier.jpeg', title: 'Arsonry Local Cloud', desc: 'Système de mini-cloud interne fournissant DNS, SMB, FTP, HTTP, bases de données et interface de gestion de fichiers avec quotas.', tags: ['Docker', 'DevOps'], github: 'https://github.com/ibzocraft/arsonry-local-cloud' },
    { cat: 'product', img: '/src/images/vote-section.jpeg', title: 'Plateforme-vote', desc: 'Plateforme électorale sécurisée et anonyme pour les établissements avec vérification d’accès, scrutin anonyme et suivi administratif en temps réel • 2026', tags: ['Next.js', 'TypeScript', 'Supabase'], github: 'https://github.com/cheikh2108/Plateforme-vote', site: 'https://plateforme-vote.vercel.app' }
  ];
  ...
  const portfolioFilters = [
    ...
    { value: 'wordpress', label: 'WordPress & e-commerce' }
  ];
